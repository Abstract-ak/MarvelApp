...
const ProductRange = () => {
    ...
    return (
        <>
            <div className="container mx-auto py-16">
                <div className="mb-8">
                    ...
                    <div className="flex justify-between items-end">
                        <div>
                            <h2 className="text-3xl md:text-4xl font-bold mb-2">Explore our selection of products</h2>
                            <p className="text-gray-600">Take a closer look and find the perfect fit for your requirements today.</p>
                        </div>
            ...
            <div className="w-full bg-gradient-to-r from-[#71B742] via-[#37A849] via-[#3EA544] to-[#1C9B47] py-16 -mt-32 pt-48">
                <div className="container mx-auto text-center text-white">
                    <h6 className="text-sm font-medium mb-2">Global Export Capabilities</h6>
